      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto">
          <li className="nav-item active">
            <Link className="nav-link" id="homelink" to="/"><i className="fa-sharp fa-solid fa-house fa-2xl"></i></Link>
          </li>
          <li className="nav-item-dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="dropdown01">
              {categories.map(header => (
                <Link key={header.trnro} className="dropdown-item" to={'/' + header.tyyppi + "pyorat"} >
          ...
          <li>
            <Link className="nav-link" id="admin" to="/admin">Admin</Link>
          </li>
          <li>
